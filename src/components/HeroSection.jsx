...
export default function HeroSection() {
  ...
  useEffect(() => {
    ...
    let targetGlobalPos = { x: 0, y: 0 };

    const handleMouseMove = (e) => {
      // Immediate update for cursor balls to stick to cursor tip
  ...
  return (
    ...
    >
      <div className="text-center z-10">
        ...
        <h2 className="text-2xl md:text-3xl mb-8 hero-subtitle" style={{ color: 'var(--primary-light-green)' }}>
      ...
      <div className="absolute top-20 left-20 w-20 h-20 rounded-full animate-float opacity-30" style={{ border: `2px solid var(--primary-green)` }}></div>
      <div className="absolute bottom-20 right-20 w-16 h-16 rounded-full animate-float opacity-30" style={{ border: `2px solid var(--primary-light-green)`, animationDelay: "-2s" }}></div>
      <div className="absolute top-1/2 left-10 w-12 h-12 rounded-full animate-float opacity-30" style={{ border: `2px solid var(--primary-magenta)`, animationDelay: "-4s" }}></div>
      
      {/* Subtle interactive particles - Reduced for smoother performance */}
      <div className="absolute top-1/3 right-1/4 w-8 h-8 rounded-full animate-float opacity-40" style={{ 
        border: `1px solid var(--primary-purple)`, 
        animationDelay: "-1s",
        transform: `translate(${mousePosition.x * 0.008}px, ${mousePosition.y * 0.008}px)`,
        willChange: 'transform'
      }}></div>
      <div className="absolute bottom-1/3 left-1/4 w-6 h-6 rounded-full animate-float opacity-50" style={{ 
        border: `1px solid var(--primary-light-green)`, 
        animationDelay: "-3s",
        transform: `translate(${mousePosition.x * -0.006}px, ${mousePosition.y * -0.006}px)`,
        willChange: 'transform'
      }}></div>
      <div className="absolute top-2/3 right-1/3 w-10 h-10 rounded-full animate-float opacity-35" style={{ 
